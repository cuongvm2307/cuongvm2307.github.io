...
import { Gamepad2, Award, Users, Star, ArrowDown } from 'lucide-react';
...
export default function Hero({ onExploreProjects, onExploreAbout }: HeroProps) {
  return (
    <section 
      id="hero" 
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center justify-center">
        ...
        <p className="text-slate-300 text-sm sm:text-lg max-w-2xl mb-10 leading-relaxed font-normal animate-fade-in-up" style={{ animationDelay: '150ms' }}>
          Chào mừng bạn đến với <strong className="text-white font-semibold">HanHi Games</strong>. Chúng tôi là tập thể của những con người đam mê mãnh liệt, không ngừng sáng tạo để biến những giấc mơ hoang đường nhất thành những kiệt tác trò chơi mang tầm thế giới.
        </p>
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center text-center p-3 border-r border-slate-800/40 md:last:border-none">
            ...
            <div className="text-2xl sm:text-3xl font-mono font-black text-white">03+</div>
            <div className="text-[10px] text-slate-400 font-bold uppercase tracking-wider mt-1">Dự Án Độc Quyền</div>
          </div>
          ...
          <div className="flex flex-col items-center justify-center text-center p-3 md:border-r border-slate-800/40">
            ...
            <div className="text-2xl sm:text-3xl font-mono font-black text-white">2.5M+</div>
            <div className="text-[10px] text-slate-400 font-bold uppercase tracking-wider mt-1">Lượt Tải Toàn Cầu</div>
          </div>
          ...
          <div className="flex flex-col items-center justify-center text-center p-3 border-r border-slate-800/40">
            ...
            <div className="text-2xl sm:text-3xl font-mono font-black text-white">4.9/5</div>
            <div className="text-[10px] text-slate-400 font-bold uppercase tracking-wider mt-1">Đánh Giá Game Thủ</div>
          </div>
          ...
          <div className="flex flex-col items-center justify-center text-center p-3">
            ...
            <div className="text-2xl sm:text-3xl font-mono font-black text-white">25+</div>
            <div className="text-[10px] text-slate-400 font-bold uppercase tracking-wider mt-1">Nhân Sự Kì Cựu</div>
          </div>
        </div>
        ...
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1.5 text-slate-500 animate-bounce cursor-pointer" onClick={onExploreProjects}>
          <span className="text-[10px] font-mono tracking-widest uppercase">Cuộn Xuống</span>
